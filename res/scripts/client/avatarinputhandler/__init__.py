...
class AvatarInputHandler(object):
    ...
    def __onArenaStarted(self, period, *args):
        ...
        self.__curCtrl.showGunMarker(show)
...
class _VertScreenshotCamera(object):
    ...
    def __init__(self):
        ...
        self.__watcherNames = ('Render/Fov', 'Render/Near Plane', 'Render/Far Plane', 'Visibility/Draw tanks', 'Visibility/Control Points', 'Visibility/GUI', 'Visibility/particles', 'Client Settings/std fog/enabled', 'Client Settings/Script tick')
