...
from gui.Scaleform.framework import GroupedViewSettings, VIEW_TYPE, ViewSettings
...
def getViewSettings():
    ...
    return [GroupedViewSettings(MESSENGER_VIEW_ALIAS.FAQ_WINDOW, FAQWindow, 'FAQWindow.swf', VIEW_TYPE.WINDOW, '', None),
     GroupedViewSettings(MESSENGER_VIEW_ALIAS.CHANNEL_MANAGEMENT_WINDOW, ChannelsManagementWindow, 'channelsManagementWindow.swf', VIEW_TYPE.WINDOW, '', ShowWindowEvent.SHOW_CHANNEL_MANAGEMENT_WINDOW),
     GroupedViewSettings(MESSENGER_VIEW_ALIAS.CONTACTS_WINDOW, ContactsWindow, 'contactsWindow.swf', VIEW_TYPE.WINDOW, '', ShowWindowEvent.SHOW_CONTACTS_WINDOW),
     GroupedViewSettings(MESSENGER_VIEW_ALIAS.LAZY_CHANNEL_WINDOW, LazyChannelWindow, 'lazyChannelWindow.swf', VIEW_TYPE.WINDOW, '', ShowWindowEvent.SHOW_LAZY_CHANNEL_WINDOW),
     GroupedViewSettings(MESSENGER_VIEW_ALIAS.LOBBY_CHANNEL_WINDOW, LobbyChannelWindow, 'lobbyChannelWindow.swf', VIEW_TYPE.WINDOW, '', ShowWindowEvent.SHOW_LOBBY_CHANNEL_WINDOW),
     GroupedViewSettings(MESSENGER_VIEW_ALIAS.CONNECT_TO_SECURE_CHANNEL_WINDOW, ConnectToSecureChannelWindow, 'connectToSecureChannelWindow.swf', VIEW_TYPE.WINDOW, '', ShowWindowEvent.SHOW_CONNECT_TO_SECURE_CHANNEL_WINDOW),
     ViewSettings(MESSENGER_VIEW_ALIAS.CHANNEL_COMPONENT, ChannelComponent, None, VIEW_TYPE.COMPONENT, None)]
