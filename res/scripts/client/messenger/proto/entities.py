...
class UserEntity(ChatEntity):
    ...
    def __init__(self, databaseID, name = 'Unknown', roster = 0, isOnline = False, clanAbbrev = None):
    ...
    def __repr__(self):
        return 'UserEntity(dbID={0!r:s}, fullName={1:>s}, roster={2:n}, isOnline={3!r:s})'.format(self._databaseID, self.getFullName(), self._roster, self._isOnline)
...
class CurrentUserEntity(UserEntity):
    ...
    def __init__(self, databaseID, name = 'Unknown', clanAbbrev = None):
        super(CurrentUserEntity, self).__init__(databaseID, name=name, isOnline=True, clanAbbrev=clanAbbrev)

    def __repr__(self):
        return 'CurrentUserEntity(dbID={0!r:s}, fullName={1:>s})'.format(self._databaseID, self.getFullName())
