...
class ShopDataParser(object):
    ...
    def __init__(self, data = None):
        self.__modulesGetters = {GUI_ITEM_TYPE.VEHICLE: vehicles.g_list.getList,
         ...
         GUI_ITEM_TYPE.EQUIPMENT: lambda *args: vehicles.g_cache.equipments(),
         GUI_ITEM_TYPE.OPTIONALDEVICE: lambda *args: vehicles.g_cache.optionalDevices()}
        self.data = data or {}
        ...
        for nIdx in itemNations:
            for typeIdx in itemTypes:
                if typeIdx in self.__modulesGetters:
                    ...
                    result.extend([ v['compactDescr'] for v in getter(nIdx).itervalues() ])
