...
class SETTINGS(object):
    ...
    GRAPHICS_DETAILS = '#settings:graphics_details'
    AUTODETECTBUTTON = '#settings:autodetectButton'
    GRAPHICSQUALITY_DEFERRED = '#settings:graphicsQuality/DEFERRED'
    GRAPHICSQUALITY_FORWARD = '#settings:graphicsQuality/FORWARD'
    GRAPHICSQUALITY_ON = '#settings:graphicsQuality/ON'
    GRAPHICSQUALITY_OFF = '#settings:graphicsQuality/OFF'
    GRAPHICSQUALITY_ANISOTROPIC_16X = '#settings:graphicsQuality/ANISOTROPIC_16X'
    GRAPHICSQUALITY_ANISOTROPIC_8X = '#settings:graphicsQuality/ANISOTROPIC_8X'
    GRAPHICSQUALITY_ANISOTROPIC_4X = '#settings:graphicsQuality/ANISOTROPIC_4X'
    GRAPHICSQUALITY_ANISOTROPIC_2X = '#settings:graphicsQuality/ANISOTROPIC_2X'
    GRAPHICSQUALITY_TRILINEAR = '#settings:graphicsQuality/TRILINEAR'
    GRAPHICSQUALITY_BILINEAR = '#settings:graphicsQuality/BILINEAR'
    GRAPHICSQUALITY_POINT = '#settings:graphicsQuality/POINT'
    GRAPHICSQUALITY_CUSTOM = '#settings:graphicsQuality/CUSTOM'
    GRAPHICSQUALITY_VERY_HIGH = '#settings:graphicsQuality/VERY_HIGH'
    GRAPHICSQUALITY_MAX = '#settings:graphicsQuality/MAX'
    GRAPHICSQUALITY_VERYHIGH = '#settings:graphicsQuality/VERYHIGH'
    GRAPHICSQUALITY_HIGH = '#settings:graphicsQuality/HIGH'
    GRAPHICSQUALITY_MEDIUM = '#settings:graphicsQuality/MEDIUM'
    GRAPHICSQUALITY_FAR = '#settings:graphicsQuality/FAR'
    GRAPHICSQUALITY_NEAR = '#settings:graphicsQuality/NEAR'
    GRAPHICSQUALITY_LOW = '#settings:graphicsQuality/LOW'
    GRAPHICSQUALITY_LOWEST = '#settings:graphicsQuality/LOWEST'
    GRAPHICSQUALITY_MIN = '#settings:graphicsQuality/MIN'
    GRAPHICSQUALITY_SHADER_MODEL_3 = '#settings:graphicsQuality/SHADER_MODEL_3'
    GRAPHICSQUALITY_SHADER_MODEL_2 = '#settings:graphicsQuality/SHADER_MODEL_2'
    GRAPHICSQUALITY_SHADER_MODEL_1 = '#settings:graphicsQuality/SHADER_MODEL_1'
    GRAPHICSQUALITY_SHADER_MODEL_0 = '#settings:graphicsQuality/SHADER_MODEL_0'
    ...
    MULTISAMPLINGTYPE = '#settings:multisamplingType'
    ...
    VERTICAL_SYNC_ON = '#settings:vertical_sync/On'
    VERTICAL_SYNC_OFF = '#settings:vertical_sync/Off'
    ...
    GRAPHICSQUALITY_ENUM = (GRAPHICSQUALITY_DEFERRED,
     GRAPHICSQUALITY_FORWARD,
     GRAPHICSQUALITY_ON,
     GRAPHICSQUALITY_OFF,
     GRAPHICSQUALITY_ANISOTROPIC_16X,
     GRAPHICSQUALITY_ANISOTROPIC_8X,
     GRAPHICSQUALITY_ANISOTROPIC_4X,
     GRAPHICSQUALITY_ANISOTROPIC_2X,
     GRAPHICSQUALITY_TRILINEAR,
     GRAPHICSQUALITY_BILINEAR,
     GRAPHICSQUALITY_POINT,
     GRAPHICSQUALITY_CUSTOM,
     GRAPHICSQUALITY_VERY_HIGH,
     GRAPHICSQUALITY_MAX,
     GRAPHICSQUALITY_VERYHIGH,
     GRAPHICSQUALITY_HIGH,
     GRAPHICSQUALITY_MEDIUM,
     GRAPHICSQUALITY_FAR,
     GRAPHICSQUALITY_NEAR,
     GRAPHICSQUALITY_LOW,
     GRAPHICSQUALITY_LOWEST,
     GRAPHICSQUALITY_MIN,
     GRAPHICSQUALITY_SHADER_MODEL_3,
     GRAPHICSQUALITY_SHADER_MODEL_2,
     GRAPHICSQUALITY_SHADER_MODEL_1,
     GRAPHICSQUALITY_SHADER_MODEL_0)
    ...
    @staticmethod
    def graphicsquality(key):
        outcome = '#settings:graphicsQuality/%s' % key
        if outcome not in SETTINGS.GRAPHICSQUALITY_ENUM:
            raise Exception, 'locale key "' + outcome + '" was not found'
        return outcome
