...
class MENU(object):
    ...
    TANKMANPERSONALCASE_MODIFIERS = '#menu:tankmanPersonalCase/modifiers'
    ...
    PREBATTLE_LEVELSTITLE = '#menu:prebattle/levelsTitle'
    ...
    MODULEFITS_TOO_HEAVY_CHASSI = '#menu:moduleFits/too_heavy_chassi'
    ...
    CONTEXTMENU_KICKPLAYER = '#menu:contextMenu/kickPlayer'
    ...
    CONTEXTMENU_OPENINGOFALLYPOS = '#menu:contextMenu/openingOfAllyPos'
    CONTEXTMENU_ALLYEJECTION = '#menu:contextMenu/allyEjection'
    CONTEXTMENU_NOTFAIRPLAY = '#menu:contextMenu/notFairPlay'
    CONTEXTMENU_TEAMKILL = '#menu:contextMenu/teamKill'
    ...
    CONTEXTMENU_ENUM = (CONTEXTMENU_VEHICLEINFO,
     ...
     CONTEXTMENU_EQUIP,
     CONTEXTMENU_UNLOCK,
     CONTEXTMENU_KICKPLAYER,
     CONTEXTMENU_APPEAL,
     CONTEXTMENU_OFFEND,
     CONTEXTMENU_FLOOD,
     CONTEXTMENU_OPENINGOFALLYPOS,
     CONTEXTMENU_ALLYEJECTION,
     CONTEXTMENU_NOTFAIRPLAY,
     CONTEXTMENU_TEAMKILL,
     CONTEXTMENU_BOT,
