...
class TOOLTIPS(object):
    ...
    LOBY_MESSENGER_INVITES_BUTTON = '#tooltips:loby_messenger/invites_button'
    ...
    LOBY_MESSENGER_INVITES_BUTTON_HEADER = LOBY_MESSENGER_INVITES_BUTTON + '/header'
    LOBY_MESSENGER_INVITES_BUTTON_BODY = LOBY_MESSENGER_INVITES_BUTTON + '/body'
    LOBY_MESSENGER_INVITES_BUTTON_NOTE = LOBY_MESSENGER_INVITES_BUTTON + '/note'
    ...
    def tankcaruseltooltip_vehicletype_elite(key):
        ...
        if outcome not in TOOLTIPS.TANKCARUSELTOOLTIP_VEHICLETYPE_ELITE_ENUM:
            raise Exception, 'locale key "' + outcome + '" was not found'
        return outcome
# okay decompyling res/scripts/client/gui/scaleform/locale/tooltips.pyc 
