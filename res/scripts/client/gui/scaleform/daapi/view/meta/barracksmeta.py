...
class BarracksMeta(DAAPIModule):
    ...
    def as_setTankmenS(self, tankmenCount, placesCount, tankmenInBarracks, berthPrice, berthBuyCount, tankmanArr):
        if self._isDAAPIInited():
            return self.flashObject.as_setTankmen(tankmenCount, placesCount, tankmenInBarracks, berthPrice, berthBuyCount, tankmanArr)
