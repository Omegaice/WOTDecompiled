...
from gui.prb_control.settings import REQUEST_TYPE, DEFAULT_PREBATTLE_COOLDOWN
...
# okay decompyling res/scripts/client/gui/scaleform/daapi/view/lobby/prb_windows/companieswindow.pyc 
