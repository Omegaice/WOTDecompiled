...
class ShowDialogEffect(GUIEffect, AppRef):
    ...
    def stop(self, effectID = None):
        ...
        if not isForceStop and effectID != self._dialogID:
            ...
            self._dialogID = None
            container = self.app.containerManager.getContainer(VIEW_TYPE.DIALOG)
            if container is not None:
                ...
                LOG_ERROR('Container for dialog not found')
            return
...
class ShowWindowEffect(GUIEffect, AppRef):
    ...
    def stop(self, effectID = None):
        ...
        if self.app is None:
            ...
            if container is not None:
                ...
                LOG_ERROR('Container for window not found')
            return
...
class UpdateContentEffect(GUIEffect, AppRef):
    ...
    def __init__(self):
        super(UpdateContentEffect, self).__init__()
    ...
    def play(self, effectData):
        ...
        if 'dialogID' in effectData:
            ...
            viewType = VIEW_TYPE.DIALOG
        if effectID is not None:
            container = self.app.containerManager.getContainer(viewType)
            if container is not None:
                ...
                LOG_ERROR('Container not found', effectData)
        return result
