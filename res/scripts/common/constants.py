...
if not sum([IS_CHINA,
 ...
 IS_SINGAPORE]) <= 1:
    ...
    class ARENA_BONUS_TYPE_CAPS:
        ...
        DOSSIER_CLAN = 4096
        DOSSIER_ACHIEVEMENTS = 8192
        DOSSIER_MAX15X15 = 16384
        DOSSIER_MAX7X7 = 32768
        CYBERSPORT_RATING = 65536
        REGULAR = RESULTS | DAMAGE_VEHICLE | CREDITS | XP | REWARD_FOR_ACHIEVEMENT | QUESTS | DOSSIER_TOTAL | DOSSIER_KILL_LIST | DOSSIER_15X15 | DOSSIER_ACHIEVEMENTS | DOSSIER_MAX15X15
        TRAINING = RESULTS
        COMPANY = RESULTS | DAMAGE_VEHICLE | CREDITS | XP | RANSOM | QUESTS | DOSSIER_TOTAL | DOSSIER_KILL_LIST | DOSSIER_15X15 | DOSSIER_COMPANY | DOSSIER_ACHIEVEMENTS | DOSSIER_MAX15X15
        TOURNAMENT = RESULTS
        CLAN = RESULTS | DAMAGE_VEHICLE | CREDITS | XP | RANSOM | QUESTS | DOSSIER_TOTAL | DOSSIER_KILL_LIST | DOSSIER_15X15 | DOSSIER_CLAN
        TUTORIAL = 0
        CYBERSPORT = RESULTS | DAMAGE_VEHICLE | CREDITS | XP | RANSOM | QUESTS | DOSSIER_TOTAL | DOSSIER_KILL_LIST | DOSSIER_7X7 | DOSSIER_MAX7X7 | CYBERSPORT_RATING
...
class WG_GAMES:
    ...
    ALL = (TANKS,
     ...
     GENERALS,
     BLITZ)
# okay decompyling res/scripts/common/constants.pyc 
