...
ACHIEVEMENTS = {'warrior': _makeAchieve(_AT.REPEATABLE, _AS.BATTLE, 1),
 ...
 'medalWittmann': _makeAchieve(_AT.REPEATABLE, _AS.EPIC, 27),
 'medalOrlik': _makeAchieve(_AT.REPEATABLE, _AS.EPIC, 18),
 'medalOskin': _makeAchieve(_AT.REPEATABLE, _AS.EPIC, 19),
 'medalHalonen': _makeAchieve(_AT.REPEATABLE, _AS.EPIC, 20),
 'medalBurda': _makeAchieve(_AT.REPEATABLE, _AS.EPIC, 23),
 'medalBillotte': _makeAchieve(_AT.REPEATABLE, _AS.EPIC, 33),
 'medalKolobanov': _makeAchieve(_AT.REPEATABLE, _AS.EPIC, 16),
 'medalFadin': _makeAchieve(_AT.REPEATABLE, _AS.EPIC, 30),
 'medalRadleyWalters': _makeAchieve(_AT.REPEATABLE, _AS.EPIC, 6),
 'medalLafayettePool': _makeAchieve(_AT.REPEATABLE, _AS.EPIC, 5),
 'medalBrunoPietro': _makeAchieve(_AT.REPEATABLE, _AS.EPIC, 32),
 'medalTarczay': _makeAchieve(_AT.REPEATABLE, _AS.EPIC, 31),
 'medalPascucci': _makeAchieve(_AT.REPEATABLE, _AS.EPIC, 25),
 'medalDumitru': _makeAchieve(_AT.REPEATABLE, _AS.EPIC, 24),
 'medalLehvaslaiho': _makeAchieve(_AT.REPEATABLE, _AS.EPIC, 21),
 'medalNikolas': _makeAchieve(_AT.REPEATABLE, _AS.EPIC, 17),
 'heroesOfRassenay': _makeAchieve(_AT.REPEATABLE, _AS.EPIC, 4),
 'medalDeLanglade': _makeAchieve(_AT.REPEATABLE, _AS.EPIC, 22),
 'medalTamadaYoshio': _makeAchieve(_AT.REPEATABLE, _AS.EPIC, 26),
 'kamikaze': _makeAchieve(_AT.REPEATABLE, _AS.SPECIAL, 28),
 ...
 'huntsman': _makeAchieve(_AT.REPEATABLE, _AS.MEMORIAL, 13),
 ...
 'tankExpert': _makeAchieve(_AT.CUSTOM, _AS.SPECIAL, 45),
 'tankExpert0': _makeAchieve(_AT.CUSTOM, _AS.SPECIAL, 52),
 'tankExpert1': _makeAchieve(_AT.CUSTOM, _AS.SPECIAL, 53),
 'tankExpert2': _makeAchieve(_AT.CUSTOM, _AS.SPECIAL, 54),
 'tankExpert3': _makeAchieve(_AT.CUSTOM, _AS.SPECIAL, 55),
 'tankExpert4': _makeAchieve(_AT.CUSTOM, _AS.SPECIAL, 56),
 'tankExpert5': _makeAchieve(_AT.CUSTOM, _AS.SPECIAL, 57),
 ...
 'mechanicEngineer': _makeAchieve(_AT.CUSTOM, _AS.SPECIAL, 44),
 'mechanicEngineer0': _makeAchieve(_AT.CUSTOM, _AS.SPECIAL, 46),
 'mechanicEngineer1': _makeAchieve(_AT.CUSTOM, _AS.SPECIAL, 47),
 'mechanicEngineer2': _makeAchieve(_AT.CUSTOM, _AS.SPECIAL, 48),
 'mechanicEngineer3': _makeAchieve(_AT.CUSTOM, _AS.SPECIAL, 49),
 'mechanicEngineer4': _makeAchieve(_AT.CUSTOM, _AS.SPECIAL, 50),
 'mechanicEngineer5': _makeAchieve(_AT.CUSTOM, _AS.SPECIAL, 51),
 ...
 'titleSniper': _makeAchieve(_AT.SERIES, _AS.SPECIAL, 59, 'maxSniperSeries', 'sniperSeries'),
 'invincible': _makeAchieve(_AT.SERIES, _AS.SPECIAL, 29, 'maxInvincibleSeries', 'invincibleSeries'),
 ...
 'armorPiercer': _makeAchieve(_AT.SERIES, _AS.SPECIAL, 58, 'maxPiercingSeries', 'piercingSeries'),
