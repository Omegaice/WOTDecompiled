...
def _set_RECORD_PACKING():
    ...
    _RECORD_PACKING = {'_version': ('p', 'H', 2, 32767),
     ...
     'shotsReceived': ('p', 'I', 4, 4000000001L),
     'noDamageShotsReceived': ('p', 'I', 4, 4000000001L),
     'piercedReceived': ('p', 'I', 4, 4000000001L),
     'heHitsReceived': ('p', 'I', 4, 4000000001L),
     'he_hits': ('p', 'I', 4, 4000000001L),
     'pierced': ('p', 'I', 4, 4000000001L),
...
def _set_ACCOUNT_RECORDS_LAYOUT():
    ...
    _ACCOUNT_RECORDS_LAYOUT = (['_version',
      ...
      '_dynRecPos_account'], ['vehTypeFrags', 'vehDossiersCut', 'rareAchievements'])
